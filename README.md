...
*15/03/2026* - **v1.0.0 -** Detectar e censurar CPF, E-Mail e Telefone apenas em arquivos CSV.

*18/03/2026* - **v1.1.0 -** ***Nova funcionalidade:*** Censurar de dados em **PDF** sem quebrar o formato do arquivo.

*20/03/2026* - **v1.1.1 -** ***Correção de bugs:*** Detectar e-mails corporativos em URLs de redirecionamento e não censurar, tendo em vista não ser um dado pessoal. Detectar e censurar números de telefones em listas separadas por "/".
